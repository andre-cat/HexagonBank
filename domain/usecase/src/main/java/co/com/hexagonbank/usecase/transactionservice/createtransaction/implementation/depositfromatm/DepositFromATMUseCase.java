package co.com.hexagonbank.usecase.transactionservice.createtransaction.implementation.depositfromatm;
...
public class DepositFromATMUseCase extends CreateTransactionUseCase {

    public DepositFromATMUseCase(AccountRepository accountRepository, TransactionRepository transactionRepository) {
