package co.com.hexagonbank.usecase.transactionservice.createtransaction.implementation.withdrawwithatm;
...
public class WithdrawFromATMUseCase extends CreateTransactionUseCase {

    public WithdrawFromATMUseCase(AccountRepository accountRepository, TransactionRepository transactionRepository) {
    ...
    protected Transaction addInformation(Transaction transaction) {
        ...
        transaction.setMean(TransactionMean.ATM);
        transaction.setCost(1);
        return transaction;
    }
}
